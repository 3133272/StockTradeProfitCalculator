...
################ YOU DO NOT HAVE TO EDIT CODE BELOW THIS POINT  ########################################################
    ...
    def make_data(self):
        ...
        '''
        file = open("E:/Griffith College/HCI&GUI PROGRAMMING/AssignmentOne/Assignment 01 - Files (updated)-20251024/CryptoCoins_Prices/combined.csv", "r")  # open a CSV file for reading https://docs.python.org/3/library/functions.html#open
